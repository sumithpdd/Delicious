using Delicious.Feature.Events.Models;
...
namespace Delicious.Feature.Events.Helpers
{
  public class EventHelpers
  {
    ...
    public Recipe GetFeaturedRecipe(Item item)
    {
      ...
      {
        LinkField featuredRecipeTwitterLink = featuredRecipeItem.Fields[Templates.Recipe.Fields.RecipeTwitterUrl];
        featuredRecipe.RecipeTwitterUrl = featuredRecipeTwitterLink.Url;
        LinkField featuredRecipeLinkedInLink = featuredRecipeItem.Fields[Templates.Recipe.Fields.RecipeLinkedInUrl];
        featuredRecipe.RecipeLinkedInUrl = featuredRecipeLinkedInLink.Url;
        LinkField featuredRecipeWebsiteLink = featuredRecipeItem.Fields[Templates.Recipe.Fields.RecipeWebsiteUrl];
        featuredRecipe.RecipeWebsiteUrl = featuredRecipeWebsiteLink.Url;
      }
